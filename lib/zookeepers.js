...
function filterByQuery(query, zookeepers) {
    ...
    if (query.age) {
        filteredResults = filteredResults.filter(
            // since our form data will be coming in as strings, andour JSON is storing age as a number, we must convert the query string to a number to perform a comparison:
